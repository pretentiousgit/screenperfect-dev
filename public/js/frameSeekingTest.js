/*
http://www.rob-coenen.nl/lab/html5/frame_accuracy/
...
var videolist = 	{	"mp4_base"	: { video : "http://www.rob-coenen.nl/lab/html5/frame_accuracy/video/perfect-timecoded.mp4", type : "video/mp4" },
                    	"webm"	: { video : "http://www.rob-coenen.nl/lab/html5/frame_accuracy/video/perfect-timecoded.webm", type : "video/webm" },
						"ogv"	: { video : "http://www.rob-coenen.nl/lab/html5/frame_accuracy/video/perfect-timecoded.ogv", type : "video/ogg" }
					}
...
function selectVideo(which_video) {
	...
	console.log("which_video: " + which_video);

	switch(which_video)
	{
	case "h264_base":
	 selected_video = videolist.mp4_base.video ;
	  break;
	case "webm":
	  selected_video = videolist.webm.video;
	  break;
	case "ogv":
	  selected_video = videolist.ogv.video;
	  break;
	default:
	  // whatevs
	}
...
/* ADDING VIDEO SELECTION STUFF TO ALLOW USER TO SELECT IE9 COMPATIBLE VIDEO */
	...
	// HACKERDEHACK
	/*
	replace_str = "<video id='myVideo' width='640' height='360' controls='controls'>";
